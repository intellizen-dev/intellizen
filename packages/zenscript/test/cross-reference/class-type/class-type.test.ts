...
describe('check cross reference of class type', () => {
  ...
  it('script be imported', () => {
    expect(import_scripts_provider.path[0].ref).toSatisfy<NamespaceNode<AstNode>>(ref => ref.name === 'scripts')
  ...
  it('script be imported as alias', () => {
    expect(import_scripts_provider_as_supplier.path[0].ref).toSatisfy<NamespaceNode<AstNode>>(ref => ref.name === 'scripts')
  ...
  it('class be imported', () => {
    expect(import_scripts_provider_alpha.path[0].ref).toSatisfy<NamespaceNode<AstNode>>(ref => ref.name === 'scripts')
  ...
  it('class be imported as alias', () => {
    expect(import_scripts_provider_alpha_as_beta.path[0].ref).toSatisfy<NamespaceNode<AstNode>>(ref => ref.name === 'scripts')
